<div class="block-fluid">
    <div class="form-group">
        ...
        <div class="col-md-4">
            {!! Form::text('abbreviation', null, array('placeholder' => __("messages.abbreviation"),'class' => 'form-control validate[maxSize[25]] text-input','id' => 'abbreviation','data-prompt-position' => "bottomLeft")) !!}
    ...
    <div class="toolbar bottom TAR">
        <div class="btn-group">
            ...
            <a href="{{ url('catalog/device_type') }}" class="btn btn-danger">@lang('messages.cancel')</a>
